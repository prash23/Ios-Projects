//
//  FacultyFeedbackTableViewController.swift
//  Student_Professor
//
...
class FacultyFeedbackTableViewController: UITableViewController {
    
    
    var data:[String:Double] = ["A":0.0,"B":0.0,"C":0.0,"D":0.0]
    ...
    override func viewWillAppear(animated: Bool) {
        self.navigationController?.visibleViewController?.navigationItem.title = "Feedback"
    }
